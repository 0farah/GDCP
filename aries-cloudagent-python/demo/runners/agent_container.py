...
def arg_parser(ident: str = None, port: int = 8020):
    ...
    "ident", if specified, refers to one of the standard demo personas - alice, patient, centerMed or performance.
    """
    ...
    if (not ident) or (ident != "alice"):
        parser.add_argument(
            ...
            action="store_true",
            help=(
                "Reuse connections by using Patient public key in the invite. "
...
async def test_main(
    ...
    try:
        ...
        # start the agents - patient gets a public DID and schema/cred def
